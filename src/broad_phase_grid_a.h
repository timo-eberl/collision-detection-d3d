...
// Returns the total number of cell/body key interactions (total_keys).
uint32_t dx_grid_a_build(dx_shared_state* sh, 
...
D3D12_GPU_VIRTUAL_ADDRESS dx_grid_a_get_sorted_keys(dx_state_grid_a* state);
